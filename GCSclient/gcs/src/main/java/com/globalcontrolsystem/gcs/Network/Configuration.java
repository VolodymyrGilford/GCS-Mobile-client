...
public class Configuration {
    ...
    public static final String method_authenticate = "DeviceAuthenticate";
    //endregion
    ...
    public static String MakeAuthenticateUrl(){
        return main_server + device_api + method_authenticate;
    }
    //endregion
